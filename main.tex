...
\paragraph{Q1. Label 2 coronal slices, 16/18 areas to be labelled} See exercises: Figures \ref{fig:coronalSectionII-answer} and \ref{fig:horizontalSection-answer}.
\paragraph{Q2. Label 15 parts on a coronal slice (slice in which you see pons)} See exercises: Figure \ref{fig:coronalSectionIV-answer}.

\paragraph{Q3. Describe the major formations involving the hippocampus in the associative cortex.} 
...
\paragraph{Q4. Mesencephalon: components \& nuclei (brain in a nutshell)}
...
\paragraph{Q4. Motor activity structures and fibers}
...
\paragraph{PQ2. Telencephalon: components}
\paragraph{PQ3. Hindbrain: components}
\paragraph{PQ4. Brain stem: components}
